...
//route menu
Route::get('/promote/products', [promote::class, 'products'])->name('promote.products');
Route::get('/promote/menu2', [promote::class, 'menu2'])->name('promote.menu2');
Route::get('/promote/menu', [promote::class, 'products'])->name('promote.menu');
//route order
